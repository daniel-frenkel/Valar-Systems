...
#define BOARD_TEMPLATE_ID             "TMPL65195"            // ID of the Tile Template. Can be found in Tile Template Settings
 ...
 */
  ...
  //#define BOARD_LED_PIN_R             13                    // Set R,G,B pins - if your LED is PWM RGB 
  //#define BOARD_LED_PIN_G             12
  //#define BOARD_LED_PIN_B             14
  ...
  #define BOARD_LED_INVERSE           false                 // true if LED is common anode, false if common cathode
  #define BOARD_LED_BRIGHTNESS        0                    // 0..255 brightness control
