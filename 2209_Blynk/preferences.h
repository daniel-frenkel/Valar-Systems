...
{
  stall_close = preferences_local.getInt("stall_close", 30);
  stall_open = preferences_local.getInt("stall_open", 30);
  ...
  move_to_position = preferences_local.getInt("move_to_position", 0);
